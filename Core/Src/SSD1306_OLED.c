...
void SSD1306_Display(void)
{
	...
	for(uint8_t i = 0; i < 8; i++)
	{
		...
		// bmp moze czeka na mutex, wiec dajemy yelda, bo moze juz jest gotowy, a tak to musi czekac na systicka(jakby pozwalamy na zmianę kontekstu wcześniej)
		osThreadYield();
	}
...
void SSD1306_Init(I2C_HandleTypeDef *i2c)
{
	...
	SSD1306_Command(0x14); // bez zewn zasilania do pompy napiecia
